...
def draw_box_plot():
    ...
    sns.boxplot(x=df_box['year'], y=df_box['value'], data=df_box, ax=axes[0], palette='Set1')
    axes[0].set(title='Year-wise Box Plot (Trend)', xlabel='Year', ylabel='Page Views')

    sns.boxplot(data=df_box, palette='Set1', x=df_box['month'], y=df_box['value'], ax=axes[1], order=['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'])
